...
def print_results(results_dic, results_stats_dic, model, 
      ...
      results_dic - Dictionary with key as image filename and value as a List 
             (index)idx 0 = pet image label (string)
                    ...
                    idx 4 = 1/0 (int)  where 1 = Classifier classifies image 
                            ...
                            'as-NOT-a' dog.
      results_stats_dic - Dictionary that contains the results statistics (either a
    ...
    # TODO: 6.a REPLACE print("") with CODE that prints the text string 
    ...
    for key in results_stats_dic:
        # TODO: 6.b REPLACE pass with CODE that prints out all the percentages 
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            # TODO: 6.c REPLACE pass with CODE that prints out the pet label 
